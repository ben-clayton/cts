/**
 * Common public interface for caching data used by CTS tests.
 * These utilities exist to improve the performance of the CTS, by caching
 * in-memory data that is expensive to build, or optionally serializing the
 * offline computed results to file.
 */
